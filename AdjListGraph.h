...
//		//priority_queue<iPair, vector<iPair>, greater<iPair> >
//		//	pq;
//		std::vector<float> arr(V, std::numeric_limits<float>::max());
//		std::vector<bool> visited(V, false);
//		int numVisited = 0;
//		// Create a vector for distances and initialize all
//		// distances as infinite (INF)
//		vector<float> dist(V, std::numeric_limits<float>::max());
//		vector<int> arrivedFrom(V, -1);
//
//		// Insert source itself in priority queue and initialize
//		// its distance as 0.
...
//			// in pair)
//			//int u = pq.top().second;
//			int minWeight = std::numeric_limits<float>::max();
//			int minIdx = -1;
//			for (size_t i = 0; i < V; i++)
//			{
//				if (minWeight > arr[i] && visited[i] == false)
//				{
//					minWeight = arr[i];
//					minIdx = i;
//				}
